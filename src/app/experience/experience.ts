  ...
  ngOnInit(): void {
    this.experiences.push({
        ...
        roles: [{
          ...
          techStack: 'Java EE 8, Spring boot, MySQL, Flyway, Docker, MapStruct, Junit5, Payara, AWS'
        }]
      },
      {
        name: 'Finshape',
        ...
        roles: [{
            ...
            techStack: 'Java 8, Spring boot, Tomcat, Liquibase, PostgreSql Docker, Yarn, Wiremock'
          },
          {
            ...
            techStack: 'Java 8, Apache camel, Openhub framework, Spring, Tomcat, Mapstruct, Postgresql, Docker'
          },
          {
            title: 'Junior Java developer',
